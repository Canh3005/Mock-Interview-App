...
import { DOCUMENT_FIT_ASSESSMENT_MODEL } from './documents.ai.service';
...
const CLAIM_MINING_INSTRUCTION = `You are a behavioral interview preparation assistant. Mine behavioral signals from a candidate CV and return ONLY valid JSON.
...
const BEHAVIORAL_RISK_INSTRUCTION = `You are a behavioral interview risk analyst. Identify behavioral risks in a candidate's CV claims that are NOT already covered by the seeded risks list. Return ONLY valid JSON.
