...
export const SD_PROBLEM_SEEDS: Partial<SDProblem>[] = [
  // ─── 1. URL Shortener (Pastebin / Bit.ly) ───────────────────────────────────
  {
    ...
    referenceArchitecture: {
      nodes: [
        ...
        { id: 'dns', type: 'ExternalService', label: 'DNS' },
        { id: 'cdn', type: 'CDN', label: 'CDN' },
        { id: 'lb', type: 'LoadBalancer', label: 'Load Balancer' },
        { id: 'write_api', type: 'WebServer', label: 'Write API' },
        { id: 'read_api', type: 'WebServer', label: 'Read API' },
        { id: 'cache', type: 'Cache', label: 'Memory Cache (Redis)' },
        { id: 'sql_master', type: 'DatabaseSQL', label: 'SQL Master (Write)' },
        {
          id: 'sql_replica',
          type: 'DatabaseSQL',
          label: 'SQL Replicas (Read)',
        },
        {
          id: 'object_store',
          type: 'ObjectStorage',
  ...
  // ─── 2. Twitter Timeline & Search ──────────────────────────────────────────
  {
    ...
    referenceArchitecture: {
      nodes: [
        ...
        { id: 'write_api', type: 'WebServer', label: 'Write API' },
        { id: 'read_api', type: 'WebServer', label: 'Read API' },
        { id: 'search_api', type: 'WebServer', label: 'Search API' },
        { id: 'fanout_service', type: 'Worker', label: 'Fan-out Service' },
        { id: 'user_graph', type: 'WebServer', label: 'User Graph Service' },
        {
          id: 'search_cluster',
          type: 'WebServer',
        ...
        { id: 'mq', type: 'MessageQueue', label: 'Message Queue' },
        { id: 'sql_db', type: 'DatabaseSQL', label: 'SQL Database' },
        {
          id: 'object_store',
          type: 'ObjectStorage',
  ...
  // ─── 3. Web Crawler ─────────────────────────────────────────────────────────
  {
    ...
    referenceArchitecture: {
      nodes: [
        { id: 'client', type: 'Client', label: 'Client' },
        { id: 'lb', type: 'LoadBalancer', label: 'Load Balancer' },
        { id: 'web_server', type: 'WebServer', label: 'Web Server' },
        { id: 'query_api', type: 'WebServer', label: 'Query API Server' },
        ...
        { id: 'doc_service', type: 'WebServer', label: 'Document Service' },
        { id: 'cache', type: 'Cache', label: 'Cache (Redis/Memcached)' },
        {
          id: 'nosql',
          type: 'DatabaseNoSQL',
          label: 'NoSQL DB (crawled links)',
        },
        {
          id: 'redis_queue',
          type: 'Cache',
        ...
        { id: 'mq', type: 'MessageQueue', label: 'Task Queue' },
      ],
      edges: [
  ...
  // ─── 4. Personal Finance Manager (Mint.com) ─────────────────────────────────
  {
    ...
    referenceArchitecture: {
      nodes: [
        ...
        { id: 'lb', type: 'LoadBalancer', label: 'Load Balancer' },
        { id: 'web_server', type: 'WebServer', label: 'Web Server' },
        { id: 'accounts_api', type: 'WebServer', label: 'Accounts API' },
        { id: 'read_api', type: 'WebServer', label: 'Read API' },
        { id: 'mq', type: 'MessageQueue', label: 'Message Queue (SQS)' },
        {
          id: 'extract_service',
          type: 'Worker',
        ...
        { id: 'sql_master', type: 'DatabaseSQL', label: 'SQL Master' },
        { id: 'sql_replica', type: 'DatabaseSQL', label: 'SQL Replicas' },
        {
          id: 'object_store',
          type: 'ObjectStorage',
  ...
  // ─── 6. Amazon Sales Rank ────────────────────────────────────────────────────
  {
    ...
    referenceArchitecture: {
      nodes: [
        ...
        { id: 'web_server', type: 'WebServer', label: 'Web Server' },
        { id: 'read_api', type: 'WebServer', label: 'Read API' },
        { id: 'sales_api', type: 'WebServer', label: 'Sales API' },
        { id: 'cache', type: 'Cache', label: 'Cache (Redis)' },
        { id: 'sql_master', type: 'DatabaseSQL', label: 'SQL Master' },
        { id: 'sql_replica', type: 'DatabaseSQL', label: 'SQL Replicas' },
        {
  ...
  // ─── 7. Scaling to Millions of Users on AWS ─────────────────────────────────
  {
    ...
    referenceArchitecture: {
      nodes: [
        { id: 'client', type: 'Client', label: 'Client' },
        { id: 'dns', type: 'ExternalService', label: 'DNS (Route 53)' },
        { id: 'cdn', type: 'CDN', label: 'CDN (CloudFront)' },
        { id: 'lb', type: 'LoadBalancer', label: 'Load Balancer (ELB)' },
        {
          id: 'app_servers',
          type: 'WebServer',
        ...
        { id: 'rds_master', type: 'DatabaseSQL', label: 'RDS Master (MySQL)' },
        { id: 'rds_replica', type: 'DatabaseSQL', label: 'RDS Read Replicas' },
        { id: 's3', type: 'ObjectStorage', label: 'S3 (static + cold data)' },
        { id: 'sqs', type: 'MessageQueue', label: 'SQS (async jobs)' },
        { id: 'worker', type: 'Worker', label: 'Workers (Lambda / EC2)' },
        { id: 'redshift', type: 'DatabaseSQL', label: 'Redshift (analytics)' },
      ],
      edges: [
        { from: 'client', to: 'dns', label: 'DNS lookup' },
        { from: 'client', to: 'cdn', label: 'Static assets' },
  ...
  //          System Design Interview Vol.1 (Alex Xu), cloud provider docs
  {
    ...
    referenceArchitecture: {
      nodes: [
        ...
        { id: 'rules_service', type: 'WebServer', label: 'Rules Service' },
        { id: 'rules_cache', type: 'Cache', label: 'Rules Cache (local)' },
        { id: 'rules_db', type: 'DatabaseSQL', label: 'Rules DB' },
        { id: 'api_servers', type: 'WebServer', label: 'Backend API Servers' },
        {
          id: 'mq',
          type: 'MessageQueue',
  ...
  // Real numbers: 500M DAU, 100B msgs/day (2023 Meta reports), 115k msg/s avg
  {
    ...
    referenceArchitecture: {
      nodes: [
        ...
        { id: 'lb', type: 'LoadBalancer', label: 'Load Balancer (L4)' },
        { id: 'ws_servers', type: 'WebServer', label: 'WebSocket Servers' },
        {
          id: 'conn_manager',
          type: 'Cache',
          label: 'Connection Manager (Redis)',
        },
        { id: 'chat_service', type: 'WebServer', label: 'Chat Service' },
        { id: 'mq', type: 'MessageQueue', label: 'Message Queue (Kafka)' },
        {
          id: 'cassandra',
          type: 'DatabaseNoSQL',
        ...
        { id: 'apns_fcm', type: 'ExternalService', label: 'APNs / FCM' },
        {
          id: 'media_store',
          type: 'ObjectStorage',
  ...
  // Real numbers: 10M active drivers, 2M location updates/s, 100k surge requests
  {
    ...
    referenceArchitecture: {
      nodes: [
        ...
        { id: 'api_gateway', type: 'APIGateway', label: 'API Gateway' },
        { id: 'ride_service', type: 'WebServer', label: 'Ride Service' },
        {
          id: 'location_service',
          type: 'WebServer',
        ...
        { id: 'kafka', type: 'MessageQueue', label: 'Kafka (ride requests)' },
        {
          id: 'notification_service',
          type: 'Worker',
          label: 'Notification Service',
  ...
  // Key facts: presigned S3 URL, multipart 5-10MB chunks, WebSocket + polling hybrid
  {
    ...
    referenceArchitecture: {
      nodes: [
        ...
        { id: 'lb', type: 'LoadBalancer', label: 'Load Balancer' },
        { id: 'api_gateway', type: 'APIGateway', label: 'API Gateway' },
        { id: 'file_service', type: 'WebServer', label: 'File Service' },
        {
          id: 'metadata_db',
          type: 'DatabaseNoSQL',
          label: 'File Metadata DB (DynamoDB)',
        },
        { id: 's3', type: 'ObjectStorage', label: 'Object Storage (S3)' },
        { id: 'cdn', type: 'CDN', label: 'CDN (CloudFront)' },
        {
          id: 'ws_server',
          type: 'WebServer',
  ...
  // Real numbers: 500hrs/min uploaded, 100M DAU, 1B hrs watched/day (YouTube 2023)
  {
    ...
    referenceArchitecture: {
      nodes: [
        ...
        { id: 'api_gateway', type: 'APIGateway', label: 'API Gateway' },
        { id: 'upload_service', type: 'WebServer', label: 'Upload Service' },
        { id: 's3_raw', type: 'ObjectStorage', label: 'S3 Raw Video' },
        { id: 'mq', type: 'MessageQueue', label: 'Kafka (transcode jobs)' },
        {
  ...
  // Real numbers: Google 8.5B searches/day → ~100k autocomplete QPS, p99 < 100ms requirement
  {
    ...
    referenceArchitecture: {
      nodes: [
        ...
        { id: 'lb', type: 'LoadBalancer', label: 'Load Balancer' },
        { id: 'suggestion_api', type: 'WebServer', label: 'Suggestion API' },
        {
          id: 'trie_cache',
          type: 'Cache',
          label: 'Trie Cache (Redis, top-K per prefix)',
        },
        { id: 'trie_service', type: 'WebServer', label: 'Trie Service' },
        {
          id: 'trie_db',
          type: 'DatabaseNoSQL',
        ...
        { id: 'mq', type: 'MessageQueue', label: 'Kafka (query stream)' },
        {
          id: 'agg_workers',
          type: 'Worker',
          label: 'Aggregation Workers (hourly batch)',
        },
        { id: 'freq_db', type: 'DatabaseSQL', label: 'Query Frequency DB' },
      ],
      edges: [
        {
          from: 'client',
  ...
  // Real numbers: Meta 1B+ notifications/day; APNs 2M connections/server (2016 WWDC)
  {
    ...
    referenceArchitecture: {
      nodes: [
        ...
        { id: 'router', type: 'WebServer', label: 'Notification Router' },
        {
          id: 'preference_db',
          type: 'DatabaseSQL',
          label: 'User Preference DB',
        },
        {
          id: 'template_service',
          type: 'WebServer',
        ...
        { id: 'apns', type: 'ExternalService', label: 'APNs (Apple)' },
        { id: 'fcm', type: 'ExternalService', label: 'FCN (Google)' },
        {
          id: 'email_gateway',
        ...
        },
        {
          id: 'device_token_db',
          type: 'DatabaseSQL',
          label: 'Device Token DB',
        },
        { id: 'log_db', type: 'DatabaseSQL', label: 'Notification Log DB' },
      ],
      edges: [
        {
          from: 'api_server',
