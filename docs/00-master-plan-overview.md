...
- [Phase 8: Thương mại hóa — Hệ thống Credit & Thanh toán](./phase-8-monetization-credit-system.md) - *Credit Wallet B2C, Subscription Tier, Campaign Contract B2B, tích hợp MoMo/VNPay/Stripe và chiến lược monetization toàn diện.*
